...
from attacks.instance_poisoning import InstancePoisoning
...
for drift_name, stream_class in streams.items():
    ...
    print("\n==========================")
    print("Experiment 1 — drift:", drift_name)
    print("==========================")
    ...
    for ratio in ratios:
        ...
        print("\nRunning instance poisoning ratio:", ratio)

        stream = stream_class()
        attack = InstancePoisoning(ratio)
